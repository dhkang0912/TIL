...
NICKNAME = 'C0001_KANGDOOHONG_KIMMINYEONG'
...
while True:
    ...
    HOLES = [[0 + R, 0 + R], [127, R], [254 - R, R], [R, 127 - R], [127, 127 - R], [254 - R, 127 - R]]
    ...
    if order == 1:
        ...
        elif not balls[3] == [-1, -1]:
            ballNo = 3

    else:
        if not balls[2] == [-1, -1]:
            ballNo = 2
        elif not balls[4] == [-1, -1]:
            ballNo = 4

    targetBall_x = balls[ballNo][0]
    targetBall_y = balls[ballNo][1]

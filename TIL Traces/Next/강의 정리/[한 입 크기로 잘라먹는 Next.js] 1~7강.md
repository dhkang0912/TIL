## 목차
- [목차](#목차)
- [3. 예제 코드 및 수업 자료 안내](#3-예제-코드-및-수업-자료-안내)
- [4. Next.js 소개](#4-nextjs-소개)
    - [리액트를 위한 프레임 워크](#리액트를-위한-프레임-워크)
    - [왜 Next가 인기를 끌 수 있었을까?](#왜-next가-인기를-끌-수-있었을까)
    - [라이브러리 VS 프레임워크](#라이브러리-vs-프레임워크)
- [5. 사전 렌더링](#5-사전-렌더링)
    - [브라우저의 요청에 사전에 렌더링이 완료된 HTML을 응답하는 렌더링 방식](#브라우저의-요청에-사전에-렌더링이-완료된-html을-응답하는-렌더링-방식)
    - [어떻게 CSR의 단점을 보완할까?](#어떻게-csr의-단점을-보완할까)
  - [사전 렌더링 동작 과정](#사전-렌더링-동작-과정)
  - [페이지 이동](#페이지-이동)
    - [리액트 단점 해소](#리액트-단점-해소)


## 3. 예제 코드 및 수업 자료 안내
[예제코드 링크](https://github.com/winterlood/onebite-next)
